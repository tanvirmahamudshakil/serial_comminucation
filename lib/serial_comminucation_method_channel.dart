...
/// An implementation of [SerialComminucationPlatform] that uses method channels.
class MethodChannelSerialComminucation extends SerialComminucationPlatform {
  ...
  Stream<SerialResponse> startSerial() {
    Stream<SerialResponse> data =
        eventChannel.receiveBroadcastStream().map((dynamic result) => SerialResponse.fromMap(Map<String, String>.from(result)));
